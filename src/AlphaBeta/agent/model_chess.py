#defines the actual model for making policy and value prediction given 
...
from AlphaBeta.agent.api_chess import ChessModelAPI
...
class ChessModel: #model that can be train takes obervation of the game and return value and predictions
    ...
    def get_pipes(self, num = 1):
        #creates list of pipes that observes which game state is listened. If observation comes in, return policy and value network
        if self.api is None:
    ...
    def build(self):
        #builds full keras model and store in self.model
    ...
    def load(self, config_path, weight_path):
        #config_path is the path to the file containing the entire config
        #weight_path is the path to the file containing model weights
    ...
    def save(self, config_path, weight_path):
        #config_path: path to save entire configuration
